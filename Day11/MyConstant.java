package rechargeportal.rasiha.utils;
...
public class MyConstant {
    ...
    //SWAGGER
    public static final String SWAGGER_INFO_TITLE ="Mobile recharge portal";
    public static final String SWAGGER_INFO_DESCRIPTION ="Recharge your mobiles easily";
    public static final String SWAGGER_INFO_VERSION ="1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME ="Rasiha";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="rasikaprakash109@gmail.com";
    ...
    // public static final String ADDON_UPDATE = "";
}
